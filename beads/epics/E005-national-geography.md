...
- [ ] Metro shard ingest architecture documented + 2nd mock metro (T025 — deferred)
- [ ] Vector tile or CDN strategy for 3,100+ metros (T026 — deferred)

## Sprints

| Sprint | Goal | Status |
|--------|------|--------|
| [S005](../sprints/S005-map-navigation/sprint.md) | Map nav + geography UX | In Progress |
...
| [T025](../tickets/T025-second-mock-metro.md) | Second mock metro shard | open |
| [T026](../tickets/T026-metro-tile-strategy.md) | National metro tile strategy | open |
