...
- [x] Metro shards at `data/metros/{cbsa}.geojson`
- [x] `GET /api/v1/metros/{cbsa}/geojson` API route stub
...
| [S007](../sprints/S007-adr011-follow-on/sprint.md) | Shard layout + API route | Done |
...
| [T030](../tickets/T030-metro-shard-layout.md) | Metro shard data layout migration | done |
| [T031](../tickets/T031-metro-shard-api-route.md) | Metro shard API route stub | done |
