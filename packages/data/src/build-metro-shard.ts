...
function buildFeature(
  ...
  const properties: DcMetroFeatureProperties = {
    ...
    parkScoreProxy: zip.parkScoreProxy,
    physiciansPer10k: zip.physiciansPer10k,
    schoolRatingPlaceholder: zip.schoolRatingPlaceholder,
    airportDriveMin: zip.airportDriveMin,
